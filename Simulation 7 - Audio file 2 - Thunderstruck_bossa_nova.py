...
os.chdir('C:/Cris/VoT Project/Feedback-Driven-Self-Organization/Cris way/thunderstruck - generic - Continued')
...
position         = 0
riff             = [0,0]
riff_speed       = 48 #higher this value the slowest is the spead
...
#Multiplicative input signal
if apply_new_tempo == 1:
    new_tempo   = [210,530,630,730,1210,1310,1410,1700,1910,2120,2330,2540,2750,3070,3170,3270]
    low_bound   = 0
    high_bound  = 50
...
plt.title('Thunderstruck - Bossa nova Tempo',fontsize=25, y=1.05)
...
plt.savefig('Thunderstruck Bossa nova tempo.png', dpi=500, bbox_inches='tight')
plt.show()

fig = plt.figure(figsize=(9,5))
plt.title('Multiplicative bossa nova tempo signal',fontsize=25, y=1.05)
plt.plot(rhythm, linewidth = 2)
plt.xlabel('Time (ms)', fontsize=23)
plt.ylabel('Signal value', fontsize=23)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
...
rate = 45000
wavio.write("thunderstruck_bossa_nova.wav",riff,rate)
