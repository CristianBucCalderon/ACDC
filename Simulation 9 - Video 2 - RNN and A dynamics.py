...
os.chdir('C:\Cris\VoT Project\Feedback-Driven-Self-Organization\Cris way\state space') #change to state space
...
ax.set_title('Dynamic Neural Trajectory',fontsize=20,y=1)
ax.grid(False)
...
line4, = ax.plot(x, y4,color='g', linewidth = 3)
line5, = ax.plot(x, y5,color='c', linewidth = 3)
line6, = ax.plot(x, y6,color='y', linewidth = 3)

def update_actions(num,x,y1,y2,y3,y4,y5,y6,line1,line2,line3,line4,line5,line6):
...
ax.set_title('Action sequence',fontsize=20,y=1.05)

line_actions = animation.FuncAnimation(fig, update_actions, time+1, fargs=[x,y1,y2,y3,y4,y5,y6,line1,line2,line3,line4,line5,line6],
                                   interval=1, blit=False)
