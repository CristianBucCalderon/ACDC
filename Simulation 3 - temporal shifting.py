...
#change this to the directory containing the Simulation 3 - temporal shift.py file
...
for i in range(N_trials):
    ...
    for j in range(time):
        ...
        if j < add_input_time:
            g_exc[0] += 1 #change this to -1 for slower
    ...
    fig = plt.figure()
    plt.title('Temporal shift - late start',fontsize=20)
    ...
    plt.legend()
    plt.savefig('Temporal shifting.png', dpi=500, bbox_inches='tight')
    plt.show()
