...
#change the weight of A-N for third action
W_n[2,2]  = 0.059
...
fig = plt.figure()
plt.title('Via weight change',fontsize=25, y=1.05)
...
plt.legend()
plt.savefig('Susained - weight change.png', dpi=500, bbox_inches='tight')
plt.show()
